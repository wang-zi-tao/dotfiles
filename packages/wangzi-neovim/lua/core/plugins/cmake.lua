...
require('cmake').setup({
  ...
  configure_args = { '-DCMAKE_CXX_COMPILER', 'clang++', '-DCMAKE_C_COMPILER', 'clang', '-DCMAKE_CXX_FLAGS_DEBUG', ' -static -O0 -Wall -g2 -ggdb' }, -- Default arguments that will be always passed at cmake configure step. By default tells cmake to generate `compile_commands.json`.
