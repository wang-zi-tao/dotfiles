        ...
        config = function()
            ...
            async.run(function()
                ...
                for _, workspace in pairs(workspaces) do
                    ...
                    vim.api.nvim_create_user_command("CdObsidian" .. workspace.name, function()
                        vim.cmd.cd(workspace.path)
                    end, {})
                    vim.api.nvim_create_user_command("RgObsidian" .. workspace.name, function()
                        require("trailblazer").new_trail_mark()
                        vim.cmd("Telescope live_grep search_dirs=" .. workspace.path)
                    end, {})
                    vim.api.nvim_create_user_command("FdObsidian" .. workspace.name, function()
                        require("trailblazer").new_trail_mark()
