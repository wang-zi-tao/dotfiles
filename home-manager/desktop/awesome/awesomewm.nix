{ pkgs, lib, config, ... }: {
  ...
  home.file.".config/awesome/icons".source = ./icons;
  home.file.".config/awesome/widget".source = ./widget;
  ...
  home.file.".config/awesome/module/bling".source = pkgs.fetchgit {
  ...
  home.file.".config/awesome/module/battery_widget".source = "${pkgs.fetchgit {
  ...
  home.file.".config/awesome/module/rubato".source = (pkgs.fetchgit {
  ...
  home.file.".config/awesome/module/layout-machi".source = (pkgs.fetchgit {
  ...
  home.file.".config/awesome/module/json.lua".source = (pkgs.fetchgit {
  ...
  home.file.".config/awesome/module/lua_pam".source = "${pkgs.lua-pam}";
