...
in
{
  ...
  home.file = {
    ...
    '';
  } // builtins.listToAttrs (lib.attrsets.mapAttrsToList (name: value: lib.nameValuePair ".config/nvim/parser/${lib.strings.removePrefix "tree-sitter-" name }.so" { source = "${value}/parser"; }) pkgs.tree-sitter.builtGrammars);
